...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    if (limit_text($row['product_quantity'], 10) > 0 && $row['category_id']==1) {
        echo 
        ...
        "<img class='card-img-top' src='images/switches/" .  htmlspecialchars($image_name) . ".jpg' alt='Card image cap' loading='lazy'>" .
        "<div class='card-body'>" .
    ...
    else if (limit_text($row['product_quantity'], 10) == 0 && $row['category_id']==1) 
    {
        echo 
        "<div class = 'card_container content col-lg-3 col-md-6 col-sm-6 col-12 active'>" .
        "<a href='productdetails.php?id=" . htmlspecialchars($row['product_id']) . "'>" .
